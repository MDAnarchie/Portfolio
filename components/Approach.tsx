    ...
    <section className="w-full py-20">
      ...
      <div className="my-20 flex flex-col lg:flex-row items-center justify-center gap-4">
        <Card
          ...
          description="I prioritize client collaboration, fostering open communication. We'll discuss things like site structure, navigation and what content will be most important to your audience."
        >
          <CanvasRevealEffect
            animationSpeed={5}
        ...
        <Card
          ...
          description="Once we settle on a plan, I'll start building your site. I'll keep you updated on my progress and make sure everything is looking good before we go live."
        >
          <CanvasRevealEffect
            animationSpeed={5}
