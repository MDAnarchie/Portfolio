  ...
  export const projects = [
    {
      ...
      des: "A full-stack app that allows users to check all the latest space news, launches, and get in touch with a community of space enthusiasts.",
      img: "/p1.svg",
    ...
    {
      id: 2,
      title: "Cinebuddy - a movie tracker app",
      des: "A SPA that allows users to search for movies, add them to their watchlist, and rate them. Built with fully with React",
      img: "/p2.svg",
